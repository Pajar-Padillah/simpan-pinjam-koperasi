...
<?php if ($this->session->flashdata('pinjaman')) { ?>
    <script>
        Swal.fire({
            title: 'Berhasil!',
            text: 'Tambah pinjaman berhasil, Silahkan menunggu bendahara untuk menyetujui pengajuan pinjaman anda!',
            icon: 'success',
        });
    </script>
<?php } ?>
<?php if ($this->session->flashdata('error_pinjam')) { ?>
    <script>
        Swal.fire({
            title: 'Gagal!',
            text: 'Tambah pinjaman gagal, pinjaman sudah ada!',
            icon: 'error',
        });
    </script>
<?php } ?>
<?php if ($this->session->flashdata('error_pending')) { ?>
    <script>
        Swal.fire({
            title: 'Gagal!',
            text: 'Tambah pinjaman gagal, Silahkan tunggu pinjaman sebelumnya untuk diverifikasi!',
            icon: 'error',
        });
    </script>
<?php } ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?= base_url('admin/ajukan_pinjaman') ?>" class="btn btn-primary btn-round ml-auto">
