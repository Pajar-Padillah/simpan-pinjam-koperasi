...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="assets/login/image/png" href="assets/foto/logo/logo1.png" />
    <!--===============================================================================================-->
        ...
        <div class="container-login100" style="background-image: url('assets/login/images/bg.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                <span class="login100-form-title p-b-10">
                    <a href="<?php echo base_url(); ?>" style="font-size: 35px; color: #fff;">
                        <b>KOPERASI</b></a>
                </span>
                <form class="login100-form validate-form p-b-33 p-t-5" action="" role="form" id="quickForm" method="post">
                    ...
                    <div class="container-login100-form-btn m-t-32">
                        <button class="btn2" type="button" id="login">
                            LOGIN
                        </button>
                    </div>
