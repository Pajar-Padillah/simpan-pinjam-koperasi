                                              ...
                                              <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                          ...
                                                          <a href="<?= base_url('admin/del_pegawai?id_user=') ?><?= $a->id_user ?>" class="btn btn-primary">Hapus</a>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <form action="<?= base_url('admin/update_pegawai'); ?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                          ...
                          <div class="col-sm-12">
                              <div class="form-group form-group-default">
                                  <label>Address</label>
                                  <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Address" value="<?= $a->alamat ?>">
                                  <?= form_error('alamat', '<small class="text-danger pl-3">', '</small>'); ?>
                              </div>
                          </div>
                          <div class="col-md-6 pr-0 ">
