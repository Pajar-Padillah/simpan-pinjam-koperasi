                                                ...
                                                <div class="form-button-action">
                                                    <span class="badge badge-primary">
                                                        <?php if ($this->session->userdata['id_level'] == 1) { ?>
                                                            <a href="<?= base_url('admin/tambah_angsuran/' . $a->id . '') ?>" style="font-size: 12px; color: white;">
                                                                <i class="fas fa-eye"></i> Lihat Angsuran
                                                            </a>
                                                        <?php }
                                                        if ($this->session->userdata['id_level'] == 2) {  ?>
                                                            <a href="<?= base_url('admin/tambah_angsuran/' . $a->id . '') ?>" style="font-size: 12px; color: white;">
                                                                <i class="fas fa-edit"></i> Kelola Angsuran
                                                            </a>
                                                        <?php } ?>
                                                    </span>
                                                    <span class="badge badge-info">
                                                        <a href="<?= base_url('admin/detail_angsuran/' . $a->id . '') ?>" style="font-size: 12px; color: white;">
